...
<body>
  <a id="whatsapp" href="https://api.whatsapp.com/send?phone=8096711403"><img src="imagenes/whatsapp.png" alt=""></a>
  <header>
    <div class="menu">
      <div class="contenedor">
        <p class="logo">BERNARDO SANTOS</p>
...
<div class="contenedor"
   id="contenedor-titulo-flex">
  <div class="contenedor-titulo">
  <h1>BERNARDO SANTOS</h1>
   <h2>Diseñador & Desarrollardor web</h2>
...
<img class="icono" src="imagenes/computadoras.png">
</div>
<div class="texto">
<P>Mi nombre es BERNARDO SANTOS y soy diseñador de páginas web. Tengo la experiencia en desarrollo de sitios web para pequeñas y medianas empresas, hasta tiendas en línea con carrito de compras.</p>
...
<div class="Servicios celeste">
  ...
  <img class="icono" src="imagenes/celular.png">
  <img class="ondas"
  src="imagenes/waves.png">
</div>
<div class="Servicios violeta">
...
<section id="mis-trabajos">
  <div class="contenedor">
    ...
    <div class="item">
      <a href="https://bernardosantossantos.github.io/Hosrestaurate/">
      <img src="imagenes/Anotacion.png">
      <p>Web Restaurante</p>
      </a>
    </div>
    <div class="item">
      <a href="https://bernardosantossantos.github.io/HostGym/">
      <img src="imagenes/Anotacion1.png">
      <p>Web Gimnasio</p>
      </a>
    </div>
    <div class="item">
...
<section id="por-que-trabajar">
  <div class="contenedor">
    ...
    <div class="contenedor-trabajar">
      ...
      <div class="item">
        <ul>
          <li><img src="imagenes/mobile-icon.png"alt=""></li>
  ...
  <div class="contenedor">
    ...
    <div class="contenedor-publicaciones">
      <div class="publicaciones">
       ...
       <a href="https://www.designyourway.net/blog/">lerr mas →</a>
       </div>
      </div>
      <div class="publicaciones">
       ...
       <a href="http://designbeep.com/">lerr mas →</a>
       </div>
      </div>
    </div>
  </div>
...
<a href="https://api.whatsapp.com/send?phone=8096711403">CHARLEMOS</a>
</div>
</section>
...
<section id="contacto">
  ...
  <?php } ?>
   ...
   <div class="contacto-info">
     <div class="mail"><img src="imagenes/mail-icon.png" alt="">Bernardoaaneudy@gmail.com</div>
       <div class="whatsapp"><img src="imagenes/whatsapp-icon.png"alt="">809-671-1403</div>
   </div>
...
<footer>
 <div class="contenedor">
 <div class="redes">
<a href="https://github.com/Bernardosantossantos"><img src="imagenes/github.png" alt=""></a>
<a href=https://www.linkedin.com/in/bernardo-santos"><img src="imagenes/linkedin.png" alt=""></a>

 </div>
 <div class="parrafo"></div>
 <p>© 2019 BERNARDO SANTOS | Diseñador Web Republica Dominicana. Todos los derechos reservados</p>
 </div>
</footer>
